...
date: '2017-08-23T05:35:07.322Z'
slug: 'self-positioning-react-components'
...
<Image
  alt='react.js logo'
  src='/static/images/1__jDIj2SKAE__Bp32owLoHDjw.png'
  width={700}
  height={400}
/>
...
<Image
  alt='react.js logo'
  src='https://img.youtube.com/vi/OwGAaxtAmaQ/0.jpg'
  width={700}
  height={400}
/>
...
<Image
  alt='react.js logo'
  src='/static/images/1__EkU__yoIB4aWoSRX11jYIiw.png'
  width={700}
  height={400}
/>
...
<Image
  alt='react.js logo'
  src='/static/images/1__nMWbkf4UI35QyiTOTl1WWA.png'
  width={700}
  height={400}
/>
        ...
        >
          <div>
            ...
            <div className='end-tutorial'>
              <a
                className='clickable'
                onClick={props.onTutorialFinish}
              >
                End tutorial
              </a>
              <button
                className={btnCls}
                onClick={props.onTutorialNext}
              >
                Next
              </button>
            </div>
