...
I recently purchased [nature of code](https://natureofcode.com/) and wanted to recreated the cover pattern with a ripple effect animation that responds on mouse hover.
...
The animation is on an SVG canvas that fills the entire width of the container and 70% of the viewport height, and is absolutely positioned to the top of the page
...
Then, we convert radians to degrees for easier manipulation multipling `(180 / Math.PI)`.
