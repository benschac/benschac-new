...
<Spacer size="$4" />I initially joined recurse center's programming community in the Winter 2 '16
...
<Spacer size="$4" />I ended up loosing about about a week to holiday, sick days and family
...
<Spacer size="$2" />✅ I picked a project or task to commit to for a couple of days, but always had
...
6-weeks is a short period of time to do anything.
